...
```bash
bash worldcup.sh worldcupplayerinfo.tsv
```
...
the player with the longest name(length:26): 
...
the oldest player(age:42): 
Faryd Mondragon

the youngest player(age:18): 
Jô
```
...
```bash
# 给定URL输出TOP 100访问来源主机
bash weblog.sh web_log.tsv -U /pub/winvn/readme.txt
```
...
[CUCCS/2015-linux-public-tyushua1](https://github.com/CUCCS/2015-linux-public-tyushua1/blob/c9eb0f03c513ae08deb28b662c8fc0217aebdc22/实验四/SHELL脚本编程基础.md)
